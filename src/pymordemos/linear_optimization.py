...
def linear_optimization_demo(args):
    ...
    def fom_gradient_of_functional(mu):
        return fom.output_gradient(fom.parameters.parse(mu))
    ...
    for mu in training_set:
        gradient_with_adjoint_approach = rom.output_gradient(mu, adjoint_approach=True)
        gradient_with_sensitivities = rom.output_gradient(mu, adjoint_approach=False)
    ...
    def rom_gradient_of_functional(mu):
        return rom.output_gradient(fom.parameters.parse(mu))
